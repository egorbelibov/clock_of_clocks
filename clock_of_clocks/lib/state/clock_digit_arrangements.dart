...
final Map<int, List<AnalogClockModel>> clockDigitArrangements = {
  ...
  1: arrangeClockGroups(
    clockGroups: const [
      ClockGroup(0, 0, ClockHandArrangement.w_e),
      ClockGroup(1, 6, ClockHandArrangement.w),
  ...
  4: arrangeClockGroups(
    clockGroups: const [
      ...
      ClockGroup(4, 4, ClockHandArrangement.n_e_corner),
      ClockGroup(5, 6, ClockHandArrangement.w),
      ClockGroup(7, 8, ClockHandArrangement.w_e),
  ...
  6: arrangeClockGroups(
    clockGroups: const [
      ...
      ClockGroup(17, 17, ClockHandArrangement.s_w_corner),
      ClockGroup(18, 18, ClockHandArrangement.n_w_corner),
      ClockGroup(19, 19, ClockHandArrangement.e),
  ...
  7: arrangeClockGroups(
    clockGroups: const [
      ...
      ClockGroup(1, 1, ClockHandArrangement.s_e_corner),
      ClockGroup(2, 2, ClockHandArrangement.n_e_corner),
      ClockGroup(3, 3, ClockHandArrangement.w),
      ...
      ClockGroup(20, 22, ClockHandArrangement.e),
      ClockGroup(23, 23, ClockHandArrangement.w_e),
    ],
  ),
  // DIGIT: 8.
